/*
    ...
    Funzionalità da aggiungere
        + implementare un ciclo per mandare più richieste dello stesso contenuto in range diversi
        + lettura dell'header Content-Range ritornato nella response, al fine di verificare che effettivamente
          il segmento di entity body restituito dal server coincida con quello richiesto
        + copia dell'entity body restituito nella risposta in un buffer contenente tutta la risorsa
    
    I punti di intervento nel programma sono evidenziati da un commento // e brevente spiegati in loco
